const diseases = [
    {
      ...
      imageUrl: "https://storage.googleapis.com/scancare-db/diseases/Jerawat%20Papula.jpg"
    },
    {
      id: "jpustula",
    ...
    },
    {
      ...
      imageUrl: "https://storage.googleapis.com/scancare-db/diseases/Jerawat%20Kistik.jpg"
    },
    {
      id: "jpasir",
      ...
      imageUrl: "https://storage.googleapis.com/scancare-db/diseases/Jerawat%20Pasir.jpg"
    },
    {
      id: "bopeng",
      name: "Bopeng",
      characteristics: "Bopeng merupakan salah satu jenis bekas jerawat yang cukup dalam pada kulit. Bopeng merupakan hasil penyembuhan jaringan di kulit yang tidak sempurna. Secara umum, bopeng dibedakan menjadi tiga kelompok besar, yaitu atropik, hipertropik, dan keloid. Bopeng atropik (atrophic scars) tampak sebagai cekungan di kulit, sedangkan bopeng hipertropik dan keloid terlihat menonjol.",
      causes: "Selama proses penyembuhan luka, kolagen akan diproduksi untuk memperbaiki permukaan kulit. Namun, produksi kolagen bisa terlalu banyak atau terlalu sedikit, sehingga menyebabkan terbentuknya bopeng.",
      imageUrl: "https://storage.googleapis.com/scancare-db/diseases/Bopeng.jpg"
    },
];
